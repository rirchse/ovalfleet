...
?>
    ...
    <section class="content-header">
      <h1>View List of {{$user_type}}s</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> {{$user_type}}s</a></li>
        {{-- <li><a href="#">Tables</a></li> --}}
        <li class="active">View {{$user_type}}s</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                @foreach(DB::table('relations')->leftJoin('users', 'users.id', 'relations.user_id')->where('relations.owner_id', $fleetowner->id)->where('users.user_role', $user_type)->get() as $user)
