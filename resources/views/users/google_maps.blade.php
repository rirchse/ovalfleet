...
{{-- @section('content') --}}
    ...
    {{-- <br> --}}
    <b hidden>Waypoints:</b> <br>
    <i hidden>(Ctrl+Click or Cmd+Click for multiple selection)</i> <br>
    ...
    <select id="end">
      ...
      <option value="Gurudaspur, Natore, Bangladesh">Gurudaspur, Natore, Bangladesh</option>
      <option value="Mohammadpur, Bangladesh">Mohammadpur, Bangladesh</option>
    </select>
    <br>
