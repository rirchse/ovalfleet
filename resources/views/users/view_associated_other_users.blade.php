...
?>
    ...
    <section class="content-header">
      <h1>View Associated {{ucwords($user_type)}}s</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> {{ucwords($user_type)}}s</a></li>
        {{-- <li><a href="#">Tables</a></li> --}}
        <li class="active">View Associated {{ucwords($user_type)}}s</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">List of {{ucwords($user_type)}}s</h3>
              ...
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="/associated/{{$user->user_role}}/{{$user->id}}/details" title="Associated User Details" class="label label-info"><i class="fa fa-file-text"></i></a>
