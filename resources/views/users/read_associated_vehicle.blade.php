      ...
      <div class="col-md-9"><!-- general form elements -->
        <div class="box box-primary">
          ...
          <div class="col-md-12 text-right toolbar-icon">
              <a href="/view_associated_vehicles/{{$vehicle->user_id}}" title="View Associated Vehicles" class="label label-success"><i class="fa fa-list"></i></a>
              {{-- <a href="/vehicle/{{$vehicle->id}}/edit" class="label label-warning" title="Edit Vehicle"><i class="fa fa-edit"></i></a>
              <a href="/vehicle/{{$vehicle->id}}/print" title="Print Vehicle" class="label label-info"><i class="fa fa-print"></i></a>
