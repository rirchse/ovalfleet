          ...
          <div class="box-header with-border">
            <h4 class="box-title">My {{ $user->user_role }} Information</h4>
                ...
                <div class="col-md-12 text-right toolbar-icon">
                    ...
                    <a href="/my/{{strtolower($user->user_role)}}/{{$user->id}}/remove" title="Remove from My Drivers" class="label label-danger" onclick="return confirm('Are you sure you want to remove this account from your panel?');"><i class="fa fa-remove"></i></a>
                </div>
                <div class="col-md-6">
                  <table class="table">
                      <tbody>
