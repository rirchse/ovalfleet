              ...
              <div class="box-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="shipper" id="shipper" class="form-control">
                      ...
                      @else
                      @foreach($fleetowners as $fleetowner)
                        @foreach(DB::table('users')->leftJoin('relations', 'relations.user_id', 'users.id')->where('relations.owner_id', $fleetowner->id)->where('users.user_role', 'Shipper')->get() as $shipper)
                ...
                <div class="col-md-6">
                  <div class="form-group ">
                    ...
                    <select name="driver" id="driver" class="form-control">
                      ...
                      @else
                      @foreach($fleetowners as $fleetowner)
                        @foreach(DB::table('users')->leftJoin('relations', 'relations.user_id', 'users.id')->where('relations.owner_id', $fleetowner->id)->where('users.user_role', 'Driver')->get() as $driver)
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    {{ Form::textarea('goods_description', null, ['class' => 'form-control','rows'=>'3'])}}
                  </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for='dispatcher_commission' class='control-label'> Dispatcher Commision: <input type="radio" name="discom" id="dispfix"> Fixed &nbsp; / &nbsp; <input type="radio" name="discom" id="dispcom"> Percentage</label>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for='driver_commision' class='control-label'> Driver Commision: <input type="radio" name="drivecom" id="drivfix"> Fixed &nbsp; / &nbsp; <input type="radio" name="drivecom" id="drivcom"> Percentage</label>
                    {{ Form::text('driver_commision', null, ['class' => 'form-control', 'style'=>'max-width:70%;float:left', 'placeholder'=>'Fixed amount', 'id'=>'drivalue']) }}
                ...
                <div class="col-md-6 no-padding">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      {{ Form::label('distance', 'Distance(in mile):', ['class' => 'control-label']) }}
                      {{ Form::text('distance', null, ['class' => 'form-control', 'readonly'=>''])}}
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      {{ Form::label('duration', 'Duration (time):', ['class' => 'control-label']) }}
