...
@section('content')
    ...
    <section class="content-header">
      <h1>My {{ucfirst($usertype)}}s</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> {{ucfirst($usertype)}}s</a></li>
        {{-- <li><a href="#">Tables</a></li> --}}
        <li class="active">My {{ucfirst($usertype)}}s</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">List of My {{ucfirst($usertype)}}s</h3>
