@extends('user')
@section('title', 'Associated User Details')
@section('content')
{{-- {{dd($user->owner_id)}} --}}
      ...
      <div class="col-md-9"><!-- general form elements -->
        <div class="box box-primary">
          ...
          <div class="col-md-12 text-right toolbar-icon">
            <a href="/view_associated/{{$user->owner_id}}/{{strtolower($user->user_role)}}" title="View Associated {{ $user->user_role }}s" class="label label-success"><i class="fa fa-list"></i></a>
