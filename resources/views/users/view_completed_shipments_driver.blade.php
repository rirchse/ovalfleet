...
@section('content')
    ...
    <section class="content-header">
      <h1>View Completed Shipments</h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Showing Completed Shipments</h3>
              ...
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    {{-- <a href="/shipment/{{$shipment->id}}/delete" class="label label-danger" onclick="return confirm('Are you sure want to delete this account!');"><i class="fa fa-trash"></i></a> --}}
                  </td>
                </tr>
