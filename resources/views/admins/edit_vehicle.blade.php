        ...
        <div class="col-md-10">          <!-- general form elements -->
          <div class="box box-primary">
            ...
            <div class="col-md-12 text-right toolbar-icon">
              ...
              <a href="/admin/view_vehicles" title="View Vehicles" class="label label-success"><i class="fa fa-list"></i></a>
            </div>
            <!-- /.box-header -->
            {{-- {{dd($vehicle->vehicle_type)}} --}}
            <!-- form start -->
            {!! Form::model($vehicle,['route' =>['admin.update.vehicle', $vehicle->id], 'method' => 'PUT', 'files' => true]) !!}
              <div class="box-body">
                <div class="col-md-3">
                  <div class="form-group">
                    {{ Form::label('vehicle_status', 'Status:', ['class' => 'control-label']) }}
                    {{ Form::select('vehicle_status',[''=>'Select Status', 'Active'=> 'Active', 'Inactive'=> 'Inactive', 'Out of service'=> 'Out of service', 'In Garage' => 'In Garage'], $vehicle->vehicle_status, ['class' => 'form-control'])}}
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group ">
                    ...
                    {{ Form::select('name_type', [''=>' Select Vehicle Name/Type', '18-Wheeler'=>'18-Wheeler', 'Covered Van'=>'Covered Van','Mini Truck'=>'Mini Truck'], $vehicle->name_type, ['class' => 'form-control'])}}
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group ">
                ...
                <div class="col-md-6">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        {{ Form::label('capacity', 'Load/Carrying Capacity (in tons):', ['class' => 'control-label']) }}
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        {{ Form::date('purchase_date', $vehicle->purchase_date, ['class' => 'form-control'])}}
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        {{ Form::label('mileage', 'Mileage (miles when purchased):', ['class' => 'control-label']) }}
