      ...
      <div class="col-md-9"><!-- general form elements -->
        <div class="box box-primary">
          ...
          <div class="col-md-12 text-right toolbar-icon">
              ...
              <a href="/admin/vehicle/{{$vehicle->id}}/print" title="Print Vehicle" class="label label-info"><i class="fa fa-print"></i></a>
              <a href="/admin/vehicle/{{$vehicle->id}}/delete" class="label label-danger" title="Delete Vehicle" onclick="return confirm('Are you sure you want to delete this vehicle?');"><i class="fa fa-trash"></i></a>
          </div>
