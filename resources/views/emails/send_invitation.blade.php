...
<head>
	...
	<title>Invitation | OvalFleet</title>
		...
		<div section="header" style="clear:both; padding:15px; background:#FFEDB6 url({{ $message->embed(asset('/img/angel-white-bg.png')) }}) no-repeat left bottom;">
			...
			<div name="banner" style="width:100%; display:table">
				...
				<div name="banner-text" style="display:table-cell; float:left;width:100%;max-width:60%; margin-top: 32px; text-align:right">
					<p style="font-size: 28px;color: #191616;">Welcome to OvalFleet.</p>
		...
		<div section="body" style="background:#fff; padding: 20px 25px; margin-bottom:5px">
			...
			<div style="overflow: hidden; padding:20px 30px">
				<div style="text-align:left; margin-left: 15px;font-family:sans-serif;color: #525252;">
					<h3>Subject: Invitation to Join OvalFleet</h3>

					<p style="margin-bottom: 20px;font-size: 15px;">Hi, <br> We are using OvalFleet.com to better manage our business process.</p>

					<p style="margin-bottom: 20px; font-size: 15px; color: #525252;">Please <a style="background-color: #00a1e6;color: white; padding: 7px 15px; text-decoration: none;display: inline-block;border-radius: 4px;" href="{{$host}}/create_referral/{{$user_id}}">Click Here</a> to join OvalFleet and connect with us.</p>
