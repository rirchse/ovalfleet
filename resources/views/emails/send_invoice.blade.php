		...
		<div section="body" style="background:#fff; padding: 20px 25px; margin-bottom:5px">
			...
			<div style="overflow: hidden; padding:20px 30px">
				<div style="text-align:left; margin-left: 15px;font-family:sans-serif;color: #525252;">
					<h3>Subject: Invoice</h3>

					<p style="margin-bottom: 20px;font-size: 15px;">Hi {{$name}}, <br> Your payment has completed.</p>
					...
					<p style="margin-bottom: 20px; font-size: 15px; color: #525252;"><a style="background-color: #00a1e6;color: white; padding: 7px 15px; text-decoration: none;display: inline-block;border-radius: 4px;" href="{{$host}}/invoice/{{$invoice_id}}">Click Here</a> to see details about the Invoice.</p>
